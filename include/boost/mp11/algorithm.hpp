...
struct mp_find_impl<L<
  ...
  private:
    template<class U>
    static constexpr int value = mp_find_impl<L<T...>, V>::type::value + 100;

    template<> static constexpr int value<T0> = 0;
    template<> static constexpr int value<T1> = 1;
    template<> static constexpr int value<T2> = 2;
    template<> static constexpr int value<T3> = 3;
    template<> static constexpr int value<T4> = 4;
    template<> static constexpr int value<T5> = 5;
    template<> static constexpr int value<T6> = 6;
    template<> static constexpr int value<T7> = 7;
    template<> static constexpr int value<T8> = 8;
    template<> static constexpr int value<T9> = 9;
    template<> static constexpr int value<T10> = 10;
    template<> static constexpr int value<T11> = 11;
    template<> static constexpr int value<T12> = 12;
    template<> static constexpr int value<T13> = 13;
    template<> static constexpr int value<T14> = 14;
    template<> static constexpr int value<T15> = 15;
    template<> static constexpr int value<T16> = 16;
    template<> static constexpr int value<T17> = 17;
    template<> static constexpr int value<T18> = 18;
    template<> static constexpr int value<T19> = 19;
    template<> static constexpr int value<T20> = 20;
    template<> static constexpr int value<T21> = 21;
    template<> static constexpr int value<T22> = 22;
    template<> static constexpr int value<T23> = 23;
    template<> static constexpr int value<T24> = 24;
    template<> static constexpr int value<T25> = 25;
    template<> static constexpr int value<T26> = 26;
    template<> static constexpr int value<T27> = 27;
    template<> static constexpr int value<T28> = 28;
    template<> static constexpr int value<T29> = 29;
    template<> static constexpr int value<T30> = 30;
    template<> static constexpr int value<T31> = 31;
    template<> static constexpr int value<T32> = 32;
    template<> static constexpr int value<T33> = 33;
    template<> static constexpr int value<T34> = 34;
    template<> static constexpr int value<T35> = 35;
    template<> static constexpr int value<T36> = 36;
    template<> static constexpr int value<T37> = 37;
    template<> static constexpr int value<T38> = 38;
    template<> static constexpr int value<T39> = 39;
    template<> static constexpr int value<T40> = 40;
    template<> static constexpr int value<T41> = 41;
    template<> static constexpr int value<T42> = 42;
    template<> static constexpr int value<T43> = 43;
    template<> static constexpr int value<T44> = 44;
    template<> static constexpr int value<T45> = 45;
    template<> static constexpr int value<T46> = 46;
    template<> static constexpr int value<T47> = 47;
    template<> static constexpr int value<T48> = 48;
    template<> static constexpr int value<T49> = 49;
    template<> static constexpr int value<T50> = 50;
    template<> static constexpr int value<T51> = 51;
    template<> static constexpr int value<T52> = 52;
    template<> static constexpr int value<T53> = 53;
    template<> static constexpr int value<T54> = 54;
    template<> static constexpr int value<T55> = 55;
    template<> static constexpr int value<T56> = 56;
    template<> static constexpr int value<T57> = 57;
    template<> static constexpr int value<T58> = 58;
    template<> static constexpr int value<T59> = 59;
    template<> static constexpr int value<T60> = 60;
    template<> static constexpr int value<T61> = 61;
    template<> static constexpr int value<T62> = 62;
    template<> static constexpr int value<T63> = 63;
    template<> static constexpr int value<T64> = 64;
    template<> static constexpr int value<T65> = 65;
    template<> static constexpr int value<T66> = 66;
    template<> static constexpr int value<T67> = 67;
    template<> static constexpr int value<T68> = 68;
    template<> static constexpr int value<T69> = 69;
    template<> static constexpr int value<T70> = 70;
    template<> static constexpr int value<T71> = 71;
    template<> static constexpr int value<T72> = 72;
    template<> static constexpr int value<T73> = 73;
    template<> static constexpr int value<T74> = 74;
    template<> static constexpr int value<T75> = 75;
    template<> static constexpr int value<T76> = 76;
    template<> static constexpr int value<T77> = 77;
    template<> static constexpr int value<T78> = 78;
    template<> static constexpr int value<T79> = 79;
    template<> static constexpr int value<T80> = 80;
    template<> static constexpr int value<T81> = 81;
    template<> static constexpr int value<T82> = 82;
    template<> static constexpr int value<T83> = 83;
    template<> static constexpr int value<T84> = 84;
    template<> static constexpr int value<T85> = 85;
    template<> static constexpr int value<T86> = 86;
    template<> static constexpr int value<T87> = 87;
    template<> static constexpr int value<T88> = 88;
    template<> static constexpr int value<T89> = 89;
    template<> static constexpr int value<T90> = 90;
    template<> static constexpr int value<T91> = 91;
    template<> static constexpr int value<T92> = 92;
    template<> static constexpr int value<T93> = 93;
    template<> static constexpr int value<T94> = 94;
    template<> static constexpr int value<T95> = 95;
    template<> static constexpr int value<T96> = 96;
    template<> static constexpr int value<T97> = 97;
    template<> static constexpr int value<T98> = 98;
    template<> static constexpr int value<T99> = 99;
